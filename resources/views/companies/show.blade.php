...
@section('head')
    <style>
        ...
        .btn {
            appearance:none; background:#fff; color:#111; text-decoration:none;
        ...
        .tab-link {
            ...
            padding:10px 12px; cursor:pointer; white-space:nowrap; color:#6b7280; font-weight:600;
        }
        .tab-link:focus{ outline:none }
        .tab-link.active { border-color:#111827; color:#111827; }

        /* Robust hiding for panels (CSS + [hidden]) */
        .tab-panel{ display:none !important; }
        .tab-panel.active{ display:block !important; }
        [hidden]{ display:none !important; }

        /* Grid */
        .grid-12 { display:grid; gap:16px; grid-template-columns:repeat(12, minmax(0,1fr)); }
        .span-12{ grid-column:span 12; } .span-8{ grid-column:span 8; }
        @media (max-width: 1280px){ .span-8{ grid-column:span 12; } }
        ...
        .metric .sub{ display:flex; gap:14px; color:var(--muted); font-size:12px }
        ...
        /* Generic table styles (used by other tabs) */
...
@section('content')
    <div class="page-wrap">
        <div class="page-inner">
            ...
            {{-- =========================
                 DASHBOARD – ONLY THIS CONTENT
               ========================= --}}
            @php
                // Placeholders; swap with real figures when available
                $dash = $dashboard ?? [];
            ...
            <section id="tab-dashboard" class="tab-panel active" aria-labelledby="tabbtn-dashboard">
                <div class="grid-12">
                    <div class="card span-12">
                        <div class="fin-head">
                            <div class="fin-title">Financial</div>
                            <div class="fin-actions">
                                <button class="btn primary">Manage payment methods</button>
                            </div>
                        </div>
            ...
            {{-- =========================
                 All other tabs – HIDDEN initially
               ========================= --}}
            ...
            <section id="tab-deadlines" class="tab-panel" hidden aria-labelledby="tabbtn-deadlines">
                @php
                    ...
                    // Use pre-computed next deadlines if provided by the route,
                    // otherwise derive "next per type" for this company as a safe fallback.
            ...
            <section id="tab-comms" class="tab-panel" hidden aria-labelledby="tabbtn-comms">
                <div class="card"><h3>Communications</h3>
                    <p class="muted">Hook to your email/CRM later.</p></div>
            </section>

            {{-- NOTES --}}
            <section id="tab-notes" class="tab-panel" hidden aria-labelledby="tabbtn-notes">
                <div class="card"><h3>Notes</h3>
                    <p class="muted">Internal notes placeholder.</p></div>
            </section>
    ...
    <script>
        // Robust tab toggling: class + [hidden]
