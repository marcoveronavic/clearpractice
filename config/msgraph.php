...
return [
    ...
    */
    ...
    'scopes' => env('MSGRAPH_SCOPES', 'offline_access Files.ReadWrite User.Read openid profile'),
    ...
    */
    // after (use your app's default, which is sqlite locally)
    'connection' => env('MSGRAPH_DB_CONNECTION', config('database.default')),
// if your file uses 'db_connection' or similar, set that the same way:
    'db_connection' => env('MSGRAPH_DB_CONNECTION', config('database.default')),
